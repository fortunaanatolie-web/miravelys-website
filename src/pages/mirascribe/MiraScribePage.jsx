      ...
      <main id="ms-overview-main" className="ms-page ms-page--wide mira-mkt" aria-label="MiraScribe overview">
        <section className="mira-mkt__hero mira-mkt__hero--human" aria-label="Product introduction">
          ...
          <figure className="mira-mkt__hero-human" aria-label="MiraScribe being used on a MacBook">
            <img src="/images/mirascribe/hero-human-realui-v2.webp" alt="Video editor using MiraScribe on a MacBook with the MiraScribe interface visible on the computer screen." loading="eager" fetchPriority="high" decoding="async" />
            <figcaption>
