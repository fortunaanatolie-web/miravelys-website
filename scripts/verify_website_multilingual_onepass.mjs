...
if (!storyDesktop.includes('PhoneMockup') || !storyDesktop.includes('activeIndex={activeIndex}')) fail('Desktop fixed phone flow must use one PhoneMockup synchronized to activeIndex.');
